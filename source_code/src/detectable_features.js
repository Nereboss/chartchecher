...
function truncatedButtonClicked() {
    chrome.storage.sync.set({key: "../sample_charts/LakeMeadCase.png"}, function () {
    });
    window.location.href = '/views/new_main.html';
}

function invertedButtonClicked() {
    chrome.storage.sync.set({key: "../sample_charts/stand_your_ground.jpg"}, function () {
    });
    window.location.href = '/views/new_main.html';
}

function arButtonClicked() {
    chrome.storage.sync.set({key: "../sample_charts/sunspots_smooth.png"}, function () {
    });
    window.location.href = '/views/new_main.html';
}

function labelsButtonClicked() {
    chrome.storage.sync.set({key: "../sample_charts/MissingAxisLabelsExample1.png"}, function () {
    });
    window.location.href = '/views/new_main.html';
}

function multiButtonClicked() {
    chrome.storage.sync.set({key: "../sample_charts/MultipleAxisExample.png"}, function () {
    });
    window.location.href = '/views/new_main.html';
}

function scaleButtonClicked() {
    chrome.storage.sync.set({key: "../sample_charts/InconsistentAxisExample1.png"}, function () {
    });
    window.location.href = '/views/new_main.html';
}
