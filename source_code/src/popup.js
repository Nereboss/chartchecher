...
//try to pass this to the backend, where we classify the chart type
let allImageURLS = [];
...
function displayImages() {
  ...
  const show_download_image_button = ls.show_download_image_button === 'false';
        ...
        <tr>
          ${Array(columns)
            ...
            .map((_, columnIndex) => {
              ...
              //should we do the fetch thing here?
              ...
              return html`
                ...
                html`
                  <td>
                    <${OpenImageButton} imageUrl=${imageUrl} />
                  </td>`}
                ${show_download_image_button &&
                html`
                  <td>
